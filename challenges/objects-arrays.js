...
all the universities in the graduates array. 
This will be an array of strings.

Once you have the new array created, sort the universities 
alphabetically and log the result. */

const universities = [];
for (items of graduates) {
...
first name and email of each student. This will be an array of strings.

The resulting contact information strings should have a space between 
the first name and the email, like this: 
...
included in their name. Create a new array called unisWithUni that 
contains them all. This will be an array of objects. Log the result. 
*/
const unisWithUni = [];
for (items of graduates) {
  if (items.university.includes('Uni')) {
    unisWithUni.push(items.university)
  }
}
...
//follow the instructions below.  Use the specific array 
...
in front of the habitats. Populate the displayNames array with only 
the animal_name and scientific_name of each animal. displayNames 
...
named lowCaseAnimalNames, each string following this 
